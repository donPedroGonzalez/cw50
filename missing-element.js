...
{   
    ...
    firstPart = [ "Wstaw: à, en, au, aux przed nazwami miejsc", "J'habite ", "Marie est née ", "Il habite ", "Nous habitons ", "Elle est née ", "Pierre habite ", "Mes parents sont nés ", "Tu habites ", "Sophie est née ", "Ils habitent ", "Vous êtes nés ", "Mon frère habite ", "Anna est née ", "Le professeur habite " ];
    secondPart = [ "Uzupełnij przyimek w każdym zdaniu", "Paris.", "France.", "Portugal.", "États-Unis.", "Rome.", "Espagne.", "Japon.", "Londres.", "Italie.", "Canada.", "Pays-Bas.", "Berlin.", "Pologne.", "Brésil." ];
    missingElement = [ "Przyimki", "à", "en", "au", "aux", "à", "en", "au", "à", "en", "au", "aux", "à", "en", "au" ];
    hints = [ "nan", "Mieszkam w Paryżu.", "Maria urodziła się we Francji.", "On mieszka w Portugalii.", "Mieszkamy w Stanach Zjednoczonych.", "Ona urodziła się w Rzymie.", "Pierre mieszka w Hiszpanii.", "Moi rodzice urodzili się w Japonii.", "Mieszkasz w Londynie.", "Sophie urodziła się we Włoszech.", "Oni mieszkają w Kanadzie.", "Urodziliście się w Holandii.", "Mój brat mieszka w Berlinie.", "Anna urodziła się w Polsce.", "Nauczyciel mieszka w Brazylii." ];
